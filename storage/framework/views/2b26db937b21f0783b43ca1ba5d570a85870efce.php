...
<section class="testimonial-area my-2 my-md-3">
      <div class="container-fluid">
         ...
         <div class="section-title-2">
            <h2><?php echo e(__('msg.Customer Reviews')); ?></h2>
            <span class="animate-border mb-4"></span>
         </div>
         <div class="testimonial-active owl-carousel">
            <div class="inner-testimonial">
               <div class="client-content">
                  <p>The best app seen ever for buying and selling books at a one place and books including lowest price.. glad to have these kind of app developer .. At last thanks team "BooksBear" for developing such a great app. 👍</p>
               </div>
            ...
            <div class="inner-testimonial">
               <div class="client-content">
                  <p>I have buy the material from this app and trust me this the genuine app for buying the books which you want the prices are low and its affordable thank you booksbear ☺️</p>
               </div>
               <div class="client-info">
   ...
   <section class="brand-logo-area my-2 my-md-3">
      <div class="container-fluid">
         ...
         <div class="heading heading-center mb-5">
            <h2><?php echo e(__('msg.shipping_partners')); ?></h2>
            <span class="animate-border"></span>
         </div>
         <div class="brand-logo-padding bg-light-gray">
            <div class="brand-logo-active-2 owl-carousel">
               <div class="single-brand-logo">
                  <img class="lazy" data-original="<?php echo e(theme('images/ship1.jpeg')); ?>" alt="">
               </div>
               <div class="single-brand-logo">
                  <img class="lazy" data-original="<?php echo e(theme('images/ship2.png')); ?>" alt="">
               </div>
               <div class="single-brand-logo">
                  <img class="lazy" data-original="<?php echo e(theme('images/ship3.png')); ?>" alt="">
               </div>
               <div class="single-brand-logo">
                  <img class="lazy" data-original="<?php echo e(theme('images/ship4.png')); ?>" alt="">
               </div>
               <div class="single-brand-logo">
                  <img class="lazy" data-original="<?php echo e(theme('images/ship5.png')); ?>" alt="">
               </div>
               <div class="single-brand-logo">
                  <img class="lazy" data-original="<?php echo e(theme('images/ship6.png')); ?>" alt="">
               </div>
            </div>
         </div>
         </div>
      ...
      <div class="footer-inner">
         ...
         <div class="footer-bottom ">
            <div class="row mtb-30">
               ...
               <div class="col-md-4 col-12 ">
                  <div class="copy-right "><?php echo e(__('msg.copyright')); ?> &copy; <?php echo e(date('Y')); ?> <?php echo e(__('msg.made')); ?> <a href="https://booksbear.in/" target="_blank" rel="noopener noreferrer"><?php echo e(__('msg.companyname')); ?>.</a>
                  </div>
               </div>
               <div class="col-md-4 col-12">
                  <div class="payment">
...
<?php /**PATH C:\xampp\htdocs\webbooksbear\resources\views/themes/eCart/common/footer.blade.php ENDPATH**/ ?>