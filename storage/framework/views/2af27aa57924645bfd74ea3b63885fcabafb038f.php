                        ...
                        <div class="product-details-tab">
                            ...
                            <div class="single-zoom-thumb">
                                <ul class="s-tab-zoom owl-carousel single-product-active" id="gallery_01">
                                    <?php $count=1; ?>
                                    <li>
                                        <a href="#" class="elevatezoom-gallery active" data-update="" data-image="<?php echo e($data['product']->image); ?>" data-zoom-image="<?php echo e($data['product']->image); ?>" >
                                            <img src="<?php echo e($data['product']->image); ?>" alt="<?php echo e($data['product']->name ?? 'Product Image'); ?>" />
                                        </a>
                                    </li>
...
<?php /**PATH C:\xampp\htdocs\webbooksbear\resources\views/themes/eCart/product.blade.php ENDPATH**/ ?>